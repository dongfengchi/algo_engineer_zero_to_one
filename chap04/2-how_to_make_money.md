...
首先最左侧的是用户规模DAU(Daily Active User，每日活跃用户)。DAU其实是一切产品收入规模的基础，类似的指标还有MAU(Monthly Active User，每月活跃用户)。所以大部分互联网向的App在公布自己的公司数据的时候，非常重要的一个指标就是自己的DAU_MAU数据，实在是因为DAU_MAU是一切收入的基础。
...
怎么样给自己的产品做广告其实背后是有学问的。首先得知道广告位是什么样的，需要用什么样的内容做广告。被用作广告投放的内容一般被叫做素材，素材的选择一般是构造一个代表性的场景或者片段，来吸引消费者。(快来西瓜视频看虞书欣/孙燕姿的Vlog)。那选择什么样的素材或者片段呢？所以问题就转化成了，在众多可以选择的候选内容之中，选择那些可以带来最多新用户转化的内容做当素材？这就是一个比较明确的目标了，是一个可以建模或者进行统计分析的点。

还有一种广告是品牌广告，比如在楼梯间，公交站。我选择在什么地方打广告，什么时候，打多久，这直接会决定拉来的新增是否符合预期。或者现在流行的：或者电视或者综艺上的冠名广告，比方说西瓜视频独家中国好声音：因为好声音来西瓜视频的用户，就可以被归因为好声音用户。这种也是一种品牌向的拉新广告。

还有一种用户增长的常见手段是预装。购买到一个新的手机后，通常会看到这个手机上预装了很多手机App。这意味着一个用户只要买了手机，就有可能成为这个App的潜在用户。这也是拉新用户的一个常见手段。这个手段在中国智能手机红利还没有完全普及的时候，会带来大量的新增用户。
